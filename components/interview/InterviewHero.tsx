    ...
    <section className="relative mt-32 bg-background flex flex-col justify-center px-8 sm:px-16 lg:px-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl">
        ...
        <p className="text-muted text-base sm:text-lg max-w-md leading-relaxed mb-16">
          Öva inför tekniska intervjuer med en AI-driven intervjuare. Välj svårighetsgrad och ämne, så kör vi!
        </p>

        {/* Stats */}
        <div className="flex gap-16">
          <div>
            <p className="font-serif text-4xl sm:text-5xl text-foreground">{sessionCount}</p>
            <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-muted mt-1">SESSIONER</p>
          </div>
        </div>
      </div>
    </section>
